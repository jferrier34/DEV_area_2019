...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./timer-reactions/timer-reactions-routing.module').then( m => m.TimerReactionsPageRoutingModule)
  },
  {
    path: 'start-timer',
    loadChildren: () => import('./timer-reactions/start-timer/start-timer-routing.module').then( m => m.StartTimerPageRoutingModule)
  },
